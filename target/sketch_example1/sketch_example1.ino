...
//
// Uses Serial for programming the board and debug printing, and minSerial for
...
//#define DEBUG_PRINTING    // Can only be used if the Arduino has more than one serial port
...
#ifdef DEBUG_PRINTING
    debugSerial.print("MIN frame with ID ");
    debugSerial.print(min_id);
    debugSerial.print(" received at ");
...
#ifdef DEBUG_PRINTING
            debugSerial.print("Can't queue at time ");
            debugSerial.println(millis());
#endif
        }
        last_sent = now;
